...
enum class Movement_type {linear_trajectory, non_linear_trajectory, out_of_technical_field_movement, none};
...
public:
    ...
    // zero
    bool run_out_of_technical_field_movement (Board_set& boards, const Asterism& movement_start);
